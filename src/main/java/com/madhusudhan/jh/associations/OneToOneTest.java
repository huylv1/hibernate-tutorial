...
import com.madhusudhan.jh.associations.one2one.ann.Car;
import com.madhusudhan.jh.associations.one2one.ann.Engine;
...
public class OneToOneTest {
    ...
    private void initV1() {
        Configuration config = new Configuration().configure()
        			...
        			.addAnnotatedClass(Engine.class);//"associations/one2one/v1/hibernate.cfg.xml"
        factoryV1 = config.buildSessionFactory();
    }

    private void initV2() {
        Configuration config = new Configuration().configure();//"associations/one2one/v2/hibernate.cfg.xml"
        factoryV2 = config.buildSessionFactory();
    }
